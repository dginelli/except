...
public class SuspiciousLocation {
	...
	public enum LocationType {
		ARRAY_VARIABLE,
		ARRAY_INDEX,
		INDEX_USED_FOR_ARRAY_INITIALIZATION,
		ARRAY_INDEX_VARIABLE_ASSIGNMENT,
		ARRAY_INITIALIZATION,
		ARRAY_INITIALIZATION_ASSIGNMENT,
		BEFORE_ARRAY_ACCESS,
		BEFORE_VARIABLE_ACCESS,
		VARIABLE_DECLARATION,
		VARIABLE_ASSIGNMENT,
		VARIABLE_ACCESS,
		INDEX_USED_FOR_VARIABLE_ACCESS,
		METHOD_PARAMETER,
		METHOD_INVOCATION
	}
	
	public SuspiciousLocation(String className, String fileName, int lineNumber, CtElement suspiciousExpression, LocationType locationType) {
