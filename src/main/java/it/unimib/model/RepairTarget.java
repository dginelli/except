...
public class RepairTarget {
	...
	public enum GuessedFault {
		ARRAY_VARIABLE_IS_WRONG,
		ARRAY_INDEX_IS_WRONG,
		ARRAY_INITIALIZATION_IS_WRONG,
		ARRAY_INDEX_INITIALIZATION_IS_WRONG,
		MISSING_CONDITION,
		STRING_VARIABLE_IS_WRONG,
		STRING_INITIALIZATION_IS_WRONG,
		VARIABLE_IS_WRONG,
		VARIABLE_INITIALIZATION_IS_WRONG,
		VARIABLE_ASSIGNMENT_IS_WRONG,
		PARAMETER_VALUE_IS_WRONG,
		STRING_INDEX_IS_WRONG,
		METHOD_PARAMETER_IS_WRONG
	}
