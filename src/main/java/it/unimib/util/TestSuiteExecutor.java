...
public final class TestSuiteExecutor {
	...
	public static List<FailureInfo> getFailure(String programClassesPath, String testClassesPath, String dependencies,
        ...
        if (dependencies != null) {
        	...
        	try {
            	...
            	for (int i = 0; i < pathnames.length; i++) {
            		faultyProgramClassPath[2+i] = Paths.get(dependencies + File.separator + pathnames[i]).toUri().toURL();
            	}
        ...
        try {
        	...
        	/*failureInfoList.forEach((e) -> {
        		System.out.println("Stack trace line: " + e);
        	});*/
